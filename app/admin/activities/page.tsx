...
//   LogOut, Palmtree, Search, ImageOff, Settings, Menu, X
// } from "lucide-react"
...
//       .then((data: any) => setActivities(data.results ?? data))
...
//           {/* Add activity — icon only on mobile, full button on desktop */}
//           <Button
//             onClick={() => router.push("/admin/activities/new")}
//             size="sm"
//             className="bg-accent hover:bg-accent/90 text-white gap-1.5 md:hidden w-9 h-9 p-0"
//             title="Add Activity"
//           >
//             <Plus size={16} />
//           </Button>
...
//             </p>
//           </div>
//           {/* Add button — desktop only (mobile has it in header) */}
//           <Button
//             onClick={() => router.push("/admin/activities/new")}
...
//                   <div>
//                     <h3 className="text-white font-semibold text-sm lg:text-base">{activity.name}</h3>
...
//                     </div>
//                     <p className="text-muted-foreground text-xs">
//                       {activity.slots?.length ?? 0} slot{(activity.slots?.length ?? 0) !== 1 ? "s" : ""}
//                     </p>
//                   </div>
...
//                         : activity.is_visible ? <EyeOff size={12} /> : <Eye size={12} />
//                       }
...
//                       className="text-muted-foreground hover:text-red-400 gap-1.5 text-xs px-2"
//                     >
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-6xl mx-auto px-4 lg:px-6 py-5 lg:py-8 flex flex-col gap-5 lg:gap-6 pb-24 md:pb-8">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {filtered.map(activity => {
              const openT  = activity.opening_time || activity.open_time  || ""
              const closeT = activity.closing_time || activity.close_time || ""
                ...
                >
                  ...
                  <div className="p-4 flex flex-col gap-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {/* ── Operating hours pill (replaces slot count) ── */}
                      {hasHours ? (
